...
#--------------------------------------------------
# HARBOR OCI REPOSITORY Server
#--------------------------------------------------
resource "oci_core_instance" "evoharbor_server" {
  display_name                            = var.EVOHARBOR_SHORT_HOSTNAME
  compartment_id                          = var.OCI_TENANCY_ID
  ...
  source_details {
    ...
    boot_volume_vpus_per_gb = var.EVOHARBOR_BASE_VOLUME_TYPE
  }
