...
resource "oci_core_instance" "idam_replica_server" {
  ...
  shape_config {
    ocpus         = var.IDAM_REPLICA_OCPU
    memory_in_gbs = var.IDAM_REPLICA_ORAM
  }
