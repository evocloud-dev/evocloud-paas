...
resource "hcloud_server" "idam_server" {
  ...
  server_type = var.IDAM_INSTANCE_SIZE
  ...
  network {
    ...
    ip         = var.IDAM_PRIVATE_IP  # Static Private IP within subnet range
