...
variable "VCD_SHORT_HOSTNAME" {
  description = "Virtual Cloud Desktop Server Short Hostname"
  type        = string
}

variable "VCD_INSTANCE_SIZE" {
  description = "Virtual Cloud Desktop Compute Instance Flavor Size"
  type        = string
}

variable "VCD_BASE_VOLUME_TYPE" {
  description = "Virtual Cloud Desktop Base Volume Type"
  type        = string
}
...
variable "vcd_revision" {
  description = "Virtual Cloud Desktop revision version"
}