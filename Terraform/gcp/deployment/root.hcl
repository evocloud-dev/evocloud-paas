...
inputs = {
  ...
  ###########################################################################
  TALOS_AMI_NAME              = "evocloud-talos110-b010"
  TALOS_AMI_SOURCE            = "https://storage.cloud.google.com/evocloud-cnpg-cluster-backup/gcp-amd64.raw.tar.gz" #https://factory.talos.dev/image/96f8c146a67c80daad900d3fc1a6976fe11062321eee9ab6ae2a6aea88b2d26e/v1.10.3/gcp-amd64.raw.tar.gz
